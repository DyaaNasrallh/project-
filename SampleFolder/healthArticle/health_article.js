...
//  In this case, it's set to true for asynchronous operation, 
// allowing other scripts to run while the request is processed.
xhr.open('GET',url,true);
xhr.responseType = 'json';//In this step, you need to inform the XMLHttpRequest object that the expected response from the server should be in JSON format
xhr.onload=function(){
